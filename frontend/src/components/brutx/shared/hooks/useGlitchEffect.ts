...
import { DEFAULT_AUTOPLAY_INTERVAL_MS, GLITCH_AUTOPLAY_ACTIVE_DURATION_MS, GLITCH_MIN_INTERVAL_MS } from '@/components/brutx/shared/lib/defaults'
import { useReducedMotion } from '@/components/brutx/shared/hooks/useReducedMotion'
