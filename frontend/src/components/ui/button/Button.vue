...
import { iconSizeVariants, type IconSize } from '@/components/brutx/shared/lib/icon-size-variants'
import { useLocale } from '@/components/brutx/shared/hooks/useLocale'
import { DEFAULT_AUTOPLAY_INTERVAL_MS } from '@/components/brutx/shared/lib/defaults'
import { useGlitchEffect, type GlitchTrigger } from '@/components/brutx/shared/hooks/useGlitchEffect'
